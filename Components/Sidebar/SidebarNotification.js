  ...
  render () {
    return html`
      <div @click=${this.switchToggle}>
        ...
        <type-style class="size-20px regular">Notificaciones</type-style>
      </div>
    `;
  };
