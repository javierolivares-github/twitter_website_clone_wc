  ...
  render () {
    return html`
      <div @click=${this.switchToggle}>
        ...
        <type-style class="size-20px regular">Explorar</type-style>
      </div>
    `;
  };
