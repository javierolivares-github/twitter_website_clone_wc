...
class FilledAdsIcon extends LitElement {
  static styles = [
    DefaultStyles,
    DarkStyles,
    GrayStyles,
...
customElements.define('filledads-icon', FilledAdsIcon);