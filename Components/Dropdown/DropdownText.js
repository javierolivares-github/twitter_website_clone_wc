...
class DropdownText extends LitElement {
  static styles = [DropdownStyles, DefaultStyles, DarkStyles];
  ...
  constructor () {
    super();
    this.textLabel = 'Default text';
  }

  render () {
    return html`
      <div>
        <type-style label=${this.textLabel} class="size-20px regular">${this.textLabel}</type-style>
      </div>
    `
  }
}
